...
class ApiErrorHandler {
    ...
    ResponseEntity<?> exceptionHandler(Exception e) {
        ...
        if (e instanceof BaseEvenotifierException) {
            status =  ((BaseEvenotifierException) e).getHttpStatus();
            errorResponse.setCode(((BaseEvenotifierException) e).getCode());
            ...
            BaseEvenotifierException causeException = (BaseEvenotifierException) e.getCause();
